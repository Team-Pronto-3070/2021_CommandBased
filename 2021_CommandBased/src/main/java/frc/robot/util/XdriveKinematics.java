...
public class XdriveKinematics {
  ...
  /**
   * Constructs a x-drive kinematics object.
   *
   ...
   *     XdriveWheelSpeeds#normalize(double)} function to rectify this issue.
   */
  public XdriveWheelSpeeds toWheelSpeeds(
      ChassisSpeeds chassisSpeeds, Translation2d centerOfRotationMeters) {
    // We have a new center of rotation. We need to compute the matrix again.
    if (!centerOfRotationMeters.equals(m_prevCoR)) {
      System.out.println("Error: changing center of rotation is not currently supported");
      /*
   ...
   */
  public XdriveWheelSpeeds toWheelSpeeds(ChassisSpeeds chassisSpeeds) {
   ...
   *
   * @param wheelSpeeds The current x-drive wheel speeds.
   * @return The resulting chassis speed.
   */
  public ChassisSpeeds toChassisSpeeds(XdriveWheelSpeeds wheelSpeeds) {
