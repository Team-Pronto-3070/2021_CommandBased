...
/** Represents the motor voltages for a x-drive drivetrain. */
@SuppressWarnings("MemberName")
public class XdriveMotorVoltages {
  ...
  /** Constructs a XdriveMotorVoltages with zeros for all member fields. */
  public XdriveMotorVoltages() {}

  /**
   * Constructs a XdriveMotorVoltages.
   *
  ...
  public String toString() {
    return String.format(
        "XdriveMotorVoltages(Front Left: %.2f V, Front Right: %.2f V, "
