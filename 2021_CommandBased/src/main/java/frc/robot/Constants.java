...
public final class Constants {
    ...
    public static final class Drive {
        ...
        public static final double RADIUS_METERS = Units.inchesToMeters(17.284903); //distance from the center of the robot to the center of the wheels in meters
    ...
    public static final class Odometry {
        public static final int[] LEFT_PORT = new int[] {14, 15}; //dio pins for odometry wheel encoders
        public static final int[] RIGHT_PORT = new int[] {12, 13};
        public static final int[] BACK_PORT = new int[] {16, 17};

        public static final boolean LEFT_REVERSED = false;
        public static final boolean RIGHT_REVERSED = true;
        public static final boolean BACK_REVERSED = false;

        public static final double METERS_PER_PULSE_L = 0.000155852;
        public static final double METERS_PER_PULSE_R = 0.000155852;
        public static final double METERS_PER_PULSE_B = 0.000155852;
        
        public static final double BACK_METERS = Units.inchesToMeters(13.755204); //distance from the center of the robot to the center of the odometry wheels in meters
        public static final double SIDE_METERS = Units.inchesToMeters(12.876524); //left and right radii should be the same
    ...
    public static final class Teleop {
        ...
        public static final double VX_DEADZONE = 0.15;
        public static final double VY_DEADZONE = 0.15;
        public static final double OMEGA_DEADZONE = 0.15;
